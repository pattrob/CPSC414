...
def receiveOnePing(mySocket, ID, timeout, destAddr):
	...
	while 1: 
		...
		if type != 8 and packetID == ID:
			...
			send = struct.unpack("d", recPacket[28:28 + bytes])[0]
			return timeReceived - send

		#You will need to unpack the raw packet yourself

		#Be careful with the packet formatting
		#Fill in end
